 ...
 * 转成交易子链
 */
public class SunActivity extends BaseActivity implements SunContract.View{

    private static final String TAG = "SunActivity-转成交易子链";
