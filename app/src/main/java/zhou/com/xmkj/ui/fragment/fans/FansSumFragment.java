...
import zhou.com.xmkj.ui.adapter.FansAdapter;
...
public class FansSumFragment extends BaseFragment implements FansContract.View{

    private FansPresenter mPresenter = new FansPresenter((FansActivity) mContext);
    @BindView(R.id.recyclerView) RecyclerView recyclerView;
    private static String TAG = "FansSumFragment-总粉丝";
